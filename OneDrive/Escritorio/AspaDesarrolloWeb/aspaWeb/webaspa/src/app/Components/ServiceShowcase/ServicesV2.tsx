...
import { Card, CardBody, p, Avatar } from "@material-tailwind/react";
      ...
      <div className="mb-8 container mx-auto grid lg:gap-x-8 gap-y-8 grid-cols-1 lg:grid-cols-3">
        ...
        >
          <CardBody className="text-center">
            ...
            <p className="text-center mb-0 max-w-xs mx-auto text-base font-normal leading-7 !text-gray-500">
      ...
      <div className="container mx-auto grid lg:gap-x-8 gap-y-8 grid-cols-1 lg:grid-cols-3">
        ...
        >
          <CardBody className="text-center">
            ...
            <p className="text-center max-w-sm mx-auto text-base font-normal leading-7 !text-gray-500">
        ...
        <Card className="col-span-1 bg-gray-100/50" shadow={false}>
          <CardBody className="text-center">
            ...
            <p className="text-center max-w-xs mx-auto text-base font-normal leading-7 !text-gray-500">
